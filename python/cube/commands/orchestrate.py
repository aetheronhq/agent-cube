    ...
    if effective_path == "SYNTHESIS":
        ...
        if final_check["approved"] and not final_check["remaining_issues"]:
            ...
            if decisions_count < total_judges:
                ...
                console.print("[cyan]Option 1:[/cyan] Send targeted feedback to fix specific issues")
                console.print(f"  1. Review the issues:")
                console.print(f"     cube decide {task_id} --peer")
                console.print(f"  2. Send feedback to the winner ({winner}):")
                console.print(f"     cube feedback {winner} {task_id} \"<your fix instructions>\"")
                console.print(f"  3. Re-run peer review:")
                console.print(f"     cube auto {task_id} --resume-from peer-review")
                console.print()
                console.print("[cyan]Option 2:[/cyan] Run automated minor fixes round")
                console.print(f"  cube auto {task_id} --resume-from minor-fixes")
                console.print()
                console.print("[cyan]Option 3:[/cyan] Start fresh from synthesis")
                console.print(f"  cube auto {task_id} --resume-from synthesis")
