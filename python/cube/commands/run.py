...
async def run_single_agent(model: str, prompt_text: str, worktree: Path) -> None:
    ...
    stream = run_agent(worktree, model, prompt_text, session_id=None, resume=False)
...
def run_command(model: str, prompt: str, directory: str = ".") -> None:
