...
git worktree add ~/.cube/worktrees/your-project/writer-sonnet writer-sonnet/task-id
git worktree add ~/.cube/worktrees/your-project/writer-codex writer-codex/task-id

# Run agents in their own worktrees
cd ~/.cube/worktrees/your-project/writer-sonnet
cursor-agent --print --force --model sonnet-4.5-thinking "implement task"

cd ~/.cube/worktrees/your-project/writer-codex
cursor-agent --print --force --model sonnet-4.5-thinking "implement task"
```
...
./scripts/automation/stream-agent.sh \
  ~/.cube/worktrees/your-project/writer-sonnet \
  "Your prompt here"
```
...
./scripts/automation/stream-agent.sh \
  ~/.cube/worktrees/your-project/writer-codex \
  "$(cat implementation/phase-01/orchestration/task-id-writer-prompt.md)"
...
```bash
# 1. Create worktrees
git worktree add ~/.cube/worktrees/your-project/writer-sonnet writer-sonnet/01-api-client-scaffold
git worktree add ~/.cube/worktrees/your-project/writer-codex writer-codex/01-api-client-scaffold
...
# Judge 1 (Sonnet)
./scripts/automation/stream-agent.sh \
  ~/.cube/worktrees/your-project/main \
