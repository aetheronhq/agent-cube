...
def mock_config_files(tmp_path, monkeypatch):
    ...
    config_data = {
        "writers": {
            "writer_a": {"name": "opus", "model": "sonnet-4.6-thinking", "label": "Writer Opus", "color": "green"},
            "writer_b": {"name": "codex", "model": "gpt-5.1", "label": "Writer Codex", "color": "blue"},
        },
        "judges": {
            "judge_1": {"model": "sonnet-4.6-thinking", "label": "Judge 1", "color": "green"},
...
class TestUserConfig:
    ...
    def test_get_judge_config_by_key(self, mock_config_files):
        ...
        assert judge.model == "sonnet-4.6-thinking"
    ...
    def test_get_prompter_model(self, mock_config_files):
        ...
        assert get_prompter_model() == "sonnet-4.6-thinking"
