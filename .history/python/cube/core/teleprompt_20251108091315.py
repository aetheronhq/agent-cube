...
class ThinkingTeleprompter:
    ...
    def _create_panel(self) -> Panel:
        ...
        title = f"[dim]💭 {self.prefix} Thinking[/dim]" if self.prefix else "[dim]💭 Thinking[/dim]"
