...
async def run_writer(writer_info: WriterInfo, prompt: str, resume: bool) -> None:
    ...
    use_teleprompt = "thinking" in writer_info.model.lower()
    teleprompt = ThinkingTeleprompter(lines=2, width=80) if use_teleprompt else None
        ...
        with open(log_file, 'w') as f:
            ...
            async for line in stream:
                ...
                if msg:
                    ...
                    if formatted:
                        if formatted.startswith("[thinking]") and teleprompt:
